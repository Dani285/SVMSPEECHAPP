package com.Main;
import com.Transform.DiscreteFourierTransform;
...
public class MainActivity {
    ...
    static{
        System.setProperty("java.library.path","C:/Program Files/Java/jdk-15.0.1/bin");
        System.loadLibrary("libJDlib.dll");
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        //recognize words from audio file
            ...
            byte[] samples = sample_sound.readAllBytes();  //alternative to use function for getting samples
        ...
        //XYDataset xyDataset = new XYSeriesCollection(graph);          //used for display graph using JFreeChart library
        ...
        //Files.copy(sample_sound, Paths.get("C:/Users/kaloc/Desktop/Java/audio3.raw"));
        ...
        var learned_function = new SVMModel.LearnedFunction();
        learned_function.SetNormalizer(normalizer); // save normalization information
        learned_function.SetFunction(trainer.Train(samples2, labels)); // perform the actual SVM training and save the
        // results
        ...
        var probabilisticDecisionFunction = SVMModel.TrainProbabilisticDecisionFunction2(trainer, samples2, labels, 3);
        ...
        learned_pfunct
                .SetFunction(SVMModel.TrainProbabilisticDecisionFunction3(SVMModel.Reduced2(trainer, 10, 1e-3), samples2, labels, 3));
    }
}
